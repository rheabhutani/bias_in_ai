...
if (sex_bias > BIAS_LIMIT):
   print("sex_bias: ", sex_bias, ", you are ", (sex_bias - BIAS_LIMIT), "% above the bias limit")
else:
   print("sex_bias: ", sex_bias, ", you are ", -(sex_bias - BIAS_LIMIT), "% under the bias limit")

if (race_bias > BIAS_LIMIT):
   print("race_bias: ", race_bias, ", you are ", (race_bias - BIAS_LIMIT), "% above the bias limit")
else:
   print("race_bias: ", race_bias, ", you are ", -(race_bias - BIAS_LIMIT), "% under the bias limit")

if (iqa_sex_bias > BIAS_LIMIT):
   print("iqa_sex_bias: ", iqa_sex_bias, ", you are ", (iqa_sex_bias - BIAS_LIMIT), "% above the bias limit")
else:
   print("iqa_sex_bias: ", iqa_sex_bias, ", you are ", -(iqa_sex_bias - BIAS_LIMIT), "% under the bias limit")

if (iqa_race_bias > BIAS_LIMIT):
   print("iqa_race_bias: ", iqa_race_bias, ", you are ", (iqa_race_bias - BIAS_LIMIT), "% above the bias limit")
else:
